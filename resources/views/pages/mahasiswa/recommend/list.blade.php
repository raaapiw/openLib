                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><center>Edit Rekomendasi</center></th>
                                <th><center>Hapus Rekomendasi</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($recommends as $key=>$row)
                                <tr>
                                    ...
                                    <td>{{ $row->place }}</td>
                                    <td><a href="{{ route('mahasiswa.recommend.edit', $row->id)}}"><span><i class="fa fa-pencil"></i></span></a></td>
