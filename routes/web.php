...
Route::group(['middleware' => 'visitor'], function() {
    ...
    Route::get('/advanced-search', 'FrontController@advancedSearch')->name('advancedSearch');
...
Route::group(['middleware' => 'mahasiswa'], function() {
    ...
    Route::get('/mahasiswa/search', 'mahasiswa\UserController@simpleSearch')->name('mahasiswa.simpleSearch');
    Route::get('/mahasiswa/advance-search', 'mahasiswa\UserController@advancedSearch')->name('mahasiswa.advancedSearch');
